...
function loadTailoredEmailContent() {
  try {
    const filePath = path.join(__dirname, 'email_content_mapping.json');
    if (fs.existsSync(filePath)) {
      ...
      console.log('Tailored email content file not found. Run Email_Tailor.py first to generate it.');
      return {};
    }
  } catch (error) {
